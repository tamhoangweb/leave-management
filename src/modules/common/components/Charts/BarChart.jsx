...
const getPath = ({ x, y, width, height, rounded }) => `
  ...
  ${
      rounded
          ? `C${x},${y} ${x},${y} ${x + r},${y} L${x + width - r},${y} C${x + width},${y} ${x + width},${y} ${
                x + width
            },${y + r}`
          : `L${x + width},${y}`
  }
...
const BarShape = (props) => {
    ...
    const { id: firstPositiveId } = keys.find(({ id: iterId }) => !!payload[iterId]);
    ...
    return (
        <ChartWrapper {...restProps}>
            <ResponsiveContainer width="100%" height="100%">
                <RechartsBarChart data={data} barCategoryGap="20%" margin={{ top: 0, right: 0, bottom: 0, left: 0 }}>
